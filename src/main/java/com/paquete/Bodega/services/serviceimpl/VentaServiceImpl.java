...
public class VentaServiceImpl extends BaseServiceImpl<Venta, Long> implements VentaService {
    ...
    public Venta crearVentaConDetallesWine(VentaDto ventaDTO) throws Exception {
    ...
    @Transactional(rollbackOn = RuntimeException.class)
    public Venta crearVentaConDetallesRestaurante(VentaDto ventaDTO) throws Exception {
 ...
 /*   public void agregarDetalleCombo(Long idVenta, DetalleVentaDto nuevoDetalleCombo) throws Exception {
        ...
        DetalleCombo detalleCombo=  new DetalleCombo();
        detalleCombo.setCantidad(nuevoDetalleCombo.getCantidad());
        Combo combo = comboRepository.findById(nuevoDetalleCombo.getComboId()).orElse(null);


        if (combo != null) {
            detalleCombo.setSubTotal(nuevoDetalleCombo.getCantidad() * combo.getPrecioTotal());
            detalleCombo.setCombo(combo);
      ...
      List<DetalleCombo>detalleCombos=venta.getDetalleCombos();
        ...
        detalleCombos.add(detalleCombo);
    ...
    public List<Venta> listarVentaDeGrupo(Long id) {
        ...
        if (grupo != null) {
            List<Venta> ventasRestaurante = ventaRepository.findByGrupoIdAndTipoVenta(id, TipoVenta.RESTAURANTE);

            System.out.println("Ventas de tipo restaurante obtenidas: " + ventasRestaurante.size());
    ...
    public List<Venta> listarVentaDeGrupoWine(Long id) {
        Grupo grupo = grupoRepository.findById(id).orElse(null);

        if (grupo != null) {
            List<Venta> ventasRestaurante = ventaRepository.findByGrupoIdAndTipoVenta(id, TipoVenta.WINE);
